package com.example.administrator.aimaid;
...
public class STWActivity extends AppCompatActivity implements EventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stw);
        initView();
        initPermission();
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (name.equals("asr.finish")) {
            txtResult.setText(final_result);
        }
